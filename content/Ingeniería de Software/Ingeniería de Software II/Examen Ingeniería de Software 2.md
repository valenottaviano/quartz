...
1. **Realice una Estimación Primaria** para determinar si el proyecto puede ser llevado a cabo por su compañía de Software. En base a esto, indique si aconsejaría al directorio la realización del trabajo, justificando de manera precisa su respuesta.
2. De acuerdo a **una metodología de desarrollo seleccionada** (en base a su experiencia/conocimiento) qué entregables/productos intermedios establecería para una **Gestión de la Configuración**. Exponga el proceso realizado.
3. **Identifique los Requerimientos:** 4 Funcionales y 2 No Funcionales. Redáctelos teniendo en cuenta las recomendaciones enunciadas en los estándares IEEE.
4. En base a las funcionalidades requeridas y teniendo en cuenta su complejidad, **cómo encararía la estimación del proyecto** planteado.
